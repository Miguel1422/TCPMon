...
class Listener extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -908324159689273184L;
    ...
    public Listener(JTabbedPane _notebook, String name, int listenPort,
        ...
        //top.add(Box.createRigidArea(new Dimension(5, 0)));
        top.add(sslServer = new JCheckBox(TCPMon.getMessage("sslSelected00", "SSL Server")));
        sslServer.addChangeListener(new BasicButtonListener(sslServer) {
            public void stateChanged(ChangeEvent event) {
            	JCheckBox box = (JCheckBox) event.getSource();
            	boolean state = box.isSelected();
                Strings.setSslServerSelected(state);
            }
        });

        sslServer.setSelected(Strings.isSslServerSelected());
        ...
        tableModel = new DefaultTableModel(new String[]{
            ...
            TCPMon.getMessage("targetHost00", "Target Host"),
